...
fun Modifier.readerHorizontalGesture(
    ...
    if (horizontalGesture == ReaderHorizontalGesture.OFF || horizontalGesture == ReaderHorizontalGesture.PAGES || horizontalGesture == ReaderHorizontalGesture.EXPERIMENTAL || isLoading) return this
